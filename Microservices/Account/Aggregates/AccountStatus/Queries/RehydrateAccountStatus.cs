...
public class RehydrateAccountStatus
{
    ...
    private readonly ILogger<RehydrateAccountStatus> _logger;
    public RehydrateAccountStatus(HttpClient httpClient, INostify nostify, ILogger<RehydrateAccountStatus> logger)
    {
