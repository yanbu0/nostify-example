using GrpcEventRequestServer.Security;
using GrpcEventRequestServer.Services;
using nostify;
...
var startupLogger = app.Services.GetRequiredService<ILoggerFactory>().CreateLogger("GrpcEventRequestServer");
